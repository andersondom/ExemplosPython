#Hashzap
# instalar o flet (integra o python com flutter) através do command prompt
# criar um botão de iniciar chat
# popup para entrar no site
# quando entrar no chat (aparece para todo mundo)
    # mensagem de entrada no site
    # o campo e botão de enviar mensagem
# a cada mensagem que você envia (aparece para todo mundo)
    # Nome: Texto da Mensagem

# para construir site com flet precisa de três passos:

# 1 - importar o flet    
import flet as ft

# 2 - criar uma função no python que gerencia a página principal
def main(pagina):
...
# 3 - flet vai executar para chamar o aplicativo, passando a função como parâmetro
